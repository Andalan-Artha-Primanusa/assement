<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-2xl font-semibold text-gray-950">{{ __('Tambah Paket Soal') }}</h2>
                <p class="mt-1 text-sm text-gray-500">Buat paket untuk Mekanik, Operator, SHE, atau HR.</p>
            </div>
