        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                @if (request()->user()?->canViewAllSites())
                    ...
                    <a href="{{ route('admin.users.create', ['type' => 'admin']) }}" class="inline-flex min-h-[44px] items-center rounded-lg bg-gray-700 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-800">Tambah User</a>
                @endif
            </div>
        </div>
    </x-slot>
